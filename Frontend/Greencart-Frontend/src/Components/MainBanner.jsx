...
export default function MainBanner(){
    return(
        <div className="relative">
            <img src={assets.main_banner_bg} alt="Banner image" className="w-full hidden md:block"/>
            <img src={assets.main_banner_bg_sm} alt="Banner image" className="w-full md:hidden"/>
            ...
            md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24">
                ...
                max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-narmal">
                Freshness you Can Trust, savings You Will love!</h1>
            

                <div className="flex items-center mt-6 font-medium">
                    <Link to={"/products"} className="group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull transition 
