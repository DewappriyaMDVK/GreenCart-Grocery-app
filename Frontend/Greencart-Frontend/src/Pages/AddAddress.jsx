...
const InputField = ({type,placeholder,name,address,handleChange})=>{
    return(
        <input className='w-full px-2 py-2.5 border 
        border-gray-500/30 rounded outline-none 
  ...
  return (
    <div className='mt-16 pb-16'>
        ...
        <div className='flex flex-col-reverse md: flex-row justify-between mt-10'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={submitHandler()} className='space-y-3 mt-6 text-sm'>
                    <div className='grid grid-cols-2 gap-4'>
                        ...
                        name="fristName" type="text" placeholder="Frist Name"/>
                        <InputField handleChange={handleChange} address={address}
            ...
            <img className='md:mr-16 mb-16 mt-0' src={assets.add_address_iamge}/>
